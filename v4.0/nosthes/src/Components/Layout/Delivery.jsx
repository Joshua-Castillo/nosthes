    ...
    return (
        <Fragment>
            ...
            <div className="row mx-auto container maxWidth">
                <a className="col py-4 px-0 my-2" href="https://download.fantuan.ca/">
                ...
                <a className="col px-5" href="https://about.ubereats.com/ca/en/how-it-works/download-uber-eats-app/">
                ...
                <a className="col py-4 px-0" href="https://www.doordash.com/">
